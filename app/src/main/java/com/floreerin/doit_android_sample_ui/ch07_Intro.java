...
public class ch07_Intro extends AppCompatActivity {
    Button OkBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ch07_intro);

        OkBtn = findViewById(R.id.okBtn_7th);

        OkBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ch07_MainActivity.class);
