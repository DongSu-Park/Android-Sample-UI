...
public class ch06_Intro extends AppCompatActivity {
    Button OkBtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ch06_intro);

        OkBtn = findViewById(R.id.okBtn_6th);

        OkBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ch06_MainActivity.class);
